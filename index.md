...
- Keep platform-specific agent names, models, and tool commands out of the portable contract. Put Codex/ChatGPT model guidance in [Codex Model-Selection Policy](codex-model-selection-policy.md) and Claude API/agent guidance in [Claude Model-Selection Policy](claude-model-selection-policy.md).
